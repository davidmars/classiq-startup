...
<div class="container text-center py-big">
    <img alt="user name"
        ...
        <div class="fg-fluo-2">
            <a href="#tag"> Etudiant</a> |
            <a href="#tag"> Institut Catholique de Paris</a>
            <br>
            <a href="#tag"> Licence Humanité</a>
        </div>
        <div class="fg-fluo-2 py-medium">
            <a href="#" class="button naked  sz-small negative-hvr color-instagram-hvr square">
                <?=pov()->svg->use("startup-social-instagram")?>
            </a>
            <a href="#" class="button naked  sz-small negative-hvr color-facebook-hvr square">
                <?=pov()->svg->use("startup-social-facebook")?>
            </a>
            <a href="#" class="button naked  sz-small negative-hvr color-twitter-hvr square">
                <?=pov()->svg->use("startup-social-twitter")?>
            </a>
            <a href="#" class="button naked  sz-small negative-hvr color-linkedin-hvr square">
