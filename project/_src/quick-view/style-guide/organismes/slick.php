<div class="container my-big">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <label>.slick-cards + data-cards-container</label>
        </div>
        <div class="col-md-9 mb-big " data-cards-container>
            <div class="slick-cards cards-container-wrapper" data-slick='{}'>
                <?for ($i=1;$i<20;$i++):?>
                    <div class="">
                    <div class="">
                        <div class="card shadow-flat ratio-4x3 shp-rounded">
        ...
        <div class="col-md-9 mb-big cards-list shp-rounded-list shadow-flat-list">
            <?for ($i=1;$i<=4;$i++):?>
                <div>
